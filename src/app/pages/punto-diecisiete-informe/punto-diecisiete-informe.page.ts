...
@Component({
  selector: 'app-punto-diecisiete-informe',
  templateUrl: './punto-diecisiete-informe.page.html',
  styleUrls: ['./punto-diecisiete-informe.page.scss'],
})
export class PuntoDiecisieteInformePage implements OnInit {
  datosEstacion:any={
    calleNumero:'',
    ciudad:'',
    colonia:'',
    ...
    table:{
        ...
        body:[
            [
                ...
                {
                    text:'INFORME DE REVISIÓN POR LA DIRECCIÓN',fontSize:9,alignment: 'center',colSpan:2,border:[true,true,true,true],
                },{
                    
                }
                ],[
                    {
                      text:'XVII. REVISIÓN DE RESULTADOS',bold:true,alignment: 'center',colSpan:2,fillColor:'#eeeeee',border:[true,true,true,true],
                    },{
...
content: [
    {
        table:{
            widths:[60,490,],
            body:[
                   [{text:`FECHA`,fontSize:9,bold:true,fillColor:'#a5c3dd'},{}],
                   [{text:`HORA`,fontSize:9,bold:true,fillColor:'#a5c3dd'},{}],
                   [{text:`OBJETIVO`,fontSize:9,bold:true,fillColor:'#a5c3dd'},{}],
                   [{text:`ELEMENTOS DE ENTRADA`,fontSize:9,bold:true,colSpan:2,fillColor:'#a5c3dd'},{}],
                   [{
        ...
        table:{
            ...
            body:[
                ...
                [
                    ...
                    {text:``,fontSize:9,fillColor:'#a5c3dd',bold:true,alignment:'center'},
    ...
    },{text:'\n3. Objetivos y Metas',fontSize:15},{text:'\n'},
    {
      table:{
       ...
       table:{
           ...
           body:[
               [
                   ...
                   {text:'ACUERDO O ACCIÓN DE MEJORA (Descripción breve)',rowSpan:2,fontSize:10,bold:true,fillColor:'#a5c3dd',alignment:'center'},
                   ...
                   {text:'',fontSize:9,bold:true,fillColor:'#a5c3dd',alignment:'center'},
                   {text:'',fontSize:9,bold:true,fillColor:'#a5c3dd',alignment:'center'},
        ...
        table:{
            ...
            body:[
                [
                   ...
                   {text:'',bold:true,fontSize:9,alignment:'center',fillColor:'#a5c3dd'},
                   {text:'',bold:true,fontSize:9,alignment:'center',fillColor:'#a5c3dd'},
                   {text:'',bold:true,fontSize:9,alignment:'center',fillColor:'#a5c3dd'},
                   {text:'',bold:true,fontSize:9,alignment:'center',fillColor:'#a5c3dd'},
                   {text:'',bold:true,fontSize:9,alignment:'center',fillColor:'#a5c3dd'},
        ...
        table:{
            ...
            body:[
                [
                    ...
                    {text:'',bold:true,fontSize:9,fillColor:'#a5c3dd'},
                ...
                [
                    ...
                    {text:'Considera el control de los aspectos ambientales y peligros y evaluación de los riesgos e impactos ambientales, asociados a la instalación?',fontSize:9},
                    {text:'',fontSize:9},
                    {text:'',fontSize:9},
                    {text:'',fontSize:9},
                ],[
