...
export class Fo05Page implements OnInit {
  ...
  pdf() {
        ...
        return {
          table: {
            ...
            body: [
              [
                {
                  text: "Gasolinera El carril S.A. de C.V.",
                  fontSize: 19,
                  colSpan: 3,
                  bold: true
                },
              ...
              [
                {
                  text:
                    "INSPECCIÓN DE ACCESORIOS DE DESCARGA, TUBOS DE VENTEO Y POZOS DE OBSERVACIÓN",
                  colSpan: 3,
                  alignment: "center",
                  bold: true,
                  fillColor: "#ddd"
      ...
      content: [
        {
          table: {
            ...
            body: [
              [
                { text: "ACCESORIO", bold: true, fillColor: "#ddd" },
                {
                  text: "\nCUMPLE",
                  bold: true,
                  fillColor: "#ddd",
              ...
              [
                {
                  text:
                    "Manguera de descarga, buen estado, conectores y empaques"
                },
                {},
                {}
              ],
              [
                {
                  text:
                    "Codo de recuperación de vapores buen estado y hermético"
                },
                {},
                {}
              ],
              ...
              [
                { text: "Tuberías de venteo", bold: true, fillColor: "#ddd" },
                {
                  text: "CUMPLE",
                  bold: true,
                  fillColor: "#ddd",
              ...
              [
                {
                  text:
                    "Conectores y cable de tierra, bien conectado sin pintura,"
                },
                {},
                {}
              ],
              [
                {
                  text: "Válvulas de venteo o presión vacío",
                  bold: true,
                  fillColor: "#ddd"
                },
                {
              ...
              [
                { text: "Arrestador de flama", bold: true, fillColor: "#ddd" },
                {
                  text: "CUMPLE",
                  bold: true,
                  fillColor: "#ddd",
              ...
              [
                {
                  text: "Pozos de observación y monitoreo",
                  bold: true,
                  fillColor: "#ddd"
                },
                {
    ...
    this.pdfMaker.generate(
      dd,
      "XI.FO-05 INSPECCIÓN DE INSTALACIONES ELECTRICAS.pdf"
    );
  }
}
