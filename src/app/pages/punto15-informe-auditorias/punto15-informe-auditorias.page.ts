...
@Component({
  selector: 'app-punto15-informe-auditorias',
  templateUrl: './punto15-informe-auditorias.page.html',
  styleUrls: ['./punto15-informe-auditorias.page.scss'],
})
export class Punto15InformeAuditoriasPage implements OnInit {
datos:any={
  fechaInforme:'',
  descripcionHallazgo:'',
  causaHallazgo:'',
   ...
   content: [{text:'\n'},
            ...
            },
            {
                table:{
                    ...
                    body:[
                        [{text: 'TIPO DE AUDITORÍA', bold:true, fillColor: '#ddd'},{text: 'SISOPA'},{text: 'CRITERIO', bold:true, fillColor: '#ddd'},{text: 'DACG de la ASEA para implementación del SASISOPA (16/06/2016)'}]
                        ]
                }
            },
            {
            ...
            },
            {
                table:{
                    ...
                    body:[
                        [{text: 'NOMBRE', bold:true},{text:`${this.datos.nombreResponsable}`},{text: 'FECHA COMPROMISO', bold:true},{text:`${this.datos.fechaCompromiso}`}],
                        ]
                }
            },
            {
