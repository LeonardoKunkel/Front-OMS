...
export class PuntoDosRiesgosPage implements OnInit {
  ...
  pdf() {
          ...
          table: {
            ...
            body: [
              ...
              [
                ...
                {text: 'a. Cumplir programa de mantenimiento de mangueras, conexiones, accesorios, válvulas de sobrellenado, así como de accesorios de tanques y contenedores.P-IM-01 \n b. Cumplir procedimiento de P-0P-01.', fontSize:8}
              ],
              [
                {text: '3', fontSize: 8},
              ...
              [
                {text: 'PROCESO: DESPACHO DE PRODUCTOS INFLAMABLES Y COMBUSTIBLES', fontSize: 8, colSpan: 10, fillColor: '#ddd', bold: true},
                {text: '', fontSize: 8},
                {text: '', fontSize: 8},
                {text: '', fontSize: 8},
                {text: '', fontSize: 8},
    ...
    this.pdfMaker.generate(dd, 'Riesgos');
  }
}
