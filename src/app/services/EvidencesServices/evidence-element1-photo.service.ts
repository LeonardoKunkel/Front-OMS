...
export class EvidenceElement1PhotoService {
  ...
  constructor(
    ...
    getDocument(){
      return this.http.get('http://localhost:3000/evidenceDocumentElement1/');
    }
    ...
    uploadDocument( title: string, description:string, document: File){
      ...
      return this.http.post('http://localhost:3000/evidenceDocumentElement1/create', fd);
    }
}
