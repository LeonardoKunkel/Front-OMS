...
const routes: Routes = [
  ...
  {
    path: 'punto-diez-evidencia',
    loadChildren: './pages/punto-diez-evidencia/punto-diez-evidencia.module#PuntoDiezEvidenciaPageModule'
  },
  {
  ...
  {
    path: 'punto-dieciseis-evidencia',
    loadChildren: './pages/punto-dieciseis-evidencia/punto-dieciseis-evidencia.module#PuntoDieciseisEvidenciaPageModule'
  },
  {
  ...
  {
    path: 'punto-dos-asam-uno',
    loadChildren: './pages/punto-dos-asam-uno/punto-dos-asam-uno.module#PuntoDosAsamUnoPageModule'
  },
  {
    path: 'punto-dos-asam-dos',
    loadChildren: './pages/punto-dos-asam-dos/punto-dos-asam-dos.module#PuntoDosAsamDosPageModule'
  },
  {
    path: 'punto-dos-asam-tres',
    loadChildren: './pages/punto-dos-asam-tres/punto-dos-asam-tres.module#PuntoDosAsamTresPageModule'
  },
  {
    path: 'punto-dos-asam-cuatro',
    loadChildren: './pages/punto-dos-asam-cuatro/punto-dos-asam-cuatro.module#PuntoDosAsamCuatroPageModule'
  },
  {
    path: 'punto-dos-asam-cinco',
    loadChildren: './pages/punto-dos-asam-cinco/punto-dos-asam-cinco.module#PuntoDosAsamCincoPageModule'
  },
  {
    path: 'punto-dos-asam-seis',
    loadChildren: './pages/punto-dos-asam-seis/punto-dos-asam-seis.module#PuntoDosAsamSeisPageModule'
  },
  {
